                        ...
                        <div className="row">
                            <div className="col-lg-8 offset-lg-2">
                                ...
                                <div className="offset-lg-1">
                                    <Button href="/team-executive-board" variant="outline-primary" size="lg" style={{ margin: '20px' }}>Executive Board</Button>
                                    <Button href="/team-collaborator" variant="outline-primary" size="lg" style={{ margin: '20px' }}>Collaborator</Button>
                                    <Button href="/team-scholarship-holder" variant="outline-primary" size="lg" active style={{ margin: '20px' }}>Scholarship Holder</Button>
                                </div>
                            </div>
